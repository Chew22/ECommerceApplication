...
public class Chew_OrderItemAdapter extends RecyclerView.Adapter<Chew_OrderItemAdapter.OrderItemViewHolder> {

    private Context context;
    private List<ItemsModel> itemIds;

    public Chew_OrderItemAdapter(Context context, List<ItemsModel> itemIds) {
    ...
    public OrderItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.chew_order_item, parent, false);
