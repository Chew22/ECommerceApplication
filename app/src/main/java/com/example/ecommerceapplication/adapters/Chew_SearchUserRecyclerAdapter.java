...
import static com.example.ecommerceapplication.utils.Chew_FirebaseUtil.getSellerDocumentId;
...
public class Chew_SearchUserRecyclerAdapter extends FirestoreRecyclerAdapter<SellerModel, Chew_SearchUserRecyclerAdapter.UserModelViewHolder> {

    Context context;

    public Chew_SearchUserRecyclerAdapter(@NonNull FirestoreRecyclerOptions<SellerModel> options, Context context) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull UserModelViewHolder holder, int position, @NonNull SellerModel model) {
        ...
        String currentUserId = Chew_FirebaseUtil.currentUserId();
    ...
    public UserModelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.chew_search_user_recycler_row, parent, false);
